...
"""
Generate a CSV including accuracy of given SNRg and SNRq
Required arguments:
depth level
number of batch
name: included in the name of output file
SNRg: vector of values
SNRq: vector of values
...
def build_fixed_plane(SNRg,SNRq,numOfBatch=2, depth = 1,optional_trainedfile=None,optional_modelfile=None,optional_imagemean=None):
	...
	file_name = 'hypercube-' +str(now.month) + "_" + str(now.day) +"_" + str(now.year) + str(name)+".csv"
